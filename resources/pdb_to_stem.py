...
final_df = pd.read_csv('/mnt/hs189/NAfinder_3.0/Crystal/doc/Final_crystal.csv')
inpdir = '/mnt/hs189/NAfinder_3.0/Crystal/raw_frag/raw_stem'
oupdir = './refine_frag/refine_stem'
